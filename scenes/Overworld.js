    ...
    create() {
        ...
        this.physics.world.on('worldbounds', (body, blockedUp, blockedDown, blockedLeft, blockedRight) => {
            ...
            if (blockedDown) {
                ...
                this.physics.world.setBounds(500, 312, this.ROOMWIDTH-this.player.displayWidth/2,
            ...
            if (blockedRight) {
                ...
                this.ROOMWIDTH+this.player.displayWidth/2, this.ROOMWIDTH+this.player.displayWidth);
            }
            if (blockedLeft) {
                this.cameras.main.pan(
                    this.ROOMWIDTH*-0.5,
